...
tags:
  - regulation
urlSecondary: https://www.livemint.com/Opinion/W6ZKuWnyTTYv7rHD9H1foK/Using-tech-to-ensure-data-symmetry.html
urlCanonical: https://exmachina.in/27/07/2016/using-tech-to-ensure-data-symmetry/
category:
  - article
...
_The Internet and modern technologies have reduced information asymmetry in markets. With the abundance of data available today, can technology can replace regulations, ensuring data symmetry and achieving "minimum governance?"_
...
But this is no longer the case. If there is one thing the Internet and other modern technologies like the [Internet of Things](../internet-of-things) (IoT) and wearable computing has given us, it is an over-abundance of widely available data. As a result, the asymmetry of data between buyers and sellers stands at historic lows.
