...
tags:
  - biotech
urlSecondary: https://www.livemint.com/opinion/online-views/synthetic-biology-biodiversity-conservation-genetic-engineering-biotechnology-sustainable-development-11724708402818.html
urlCanonical: https://exmachina.in/28/08/2024/synthetic-biology/
Archive URL: https://archive.rahulmatthan.com/archive/1734067695.202765/www.livemint.com/opinion/online-views/synthetic-biology-biodiversity-conservation-genetic-engineering-biotechnology-sustainable-development-11724708402818.html
category: article
...
- 1. Article
    ...
    - 1.2 Access to Data
    - 1.3 Sharing Benefits
- 2. Related Articles
    - On Biotech Innovation
    - On Healthcare Innovation
    - On Investment in Science
    - On Open Access to Science
- 3. Endnotes
```
## 1. Article

We are witnessing the birth of remarkable new discipline called synthetic biology, a brand new field of study that leverages advances in genetic engineering and bio-computing to develop new biological systems that have been designed to perform specific functions. According to Boston Consulting Group[^1], synthetic biology will, by the end of the decade, account for more than a third of global output—nearly $30 trillion in value. This will force businesses in sectors as diverse as health and beauty, [fashion](../fashion) and [textiles](../textiles), food and [agriculture](../agriculture), and mining and construction to come to terms with such significant disruption that it could upend the ways in which they have traditionally functioned.

### 1.1 Commercial Applications

There are a number of different applications to which synthetic biology is being put. In the fashion industry, it has allowed us to experiment with a wide range of new fabrics and materials. Fashion brands like Hermes[^2] have already started using mycelium (the root structures of mushrooms) to create pliable new substances to substitute the leather that is usually used to make bags. Others have genetically engineered yeast to produce modified forms of collagen[^3] that produce new fabrics with improved strength, stretchability and durability and which can be designed with specific requirements, such as tear resistance or thickness, in mind.

In [a previous article]([164. The case for meat options that taste like the real thing](../164.-the-case-for-meat-options-that-taste-like-the-real-thing)), I wrote about how we should soon be able to produce artificial meat at scale, significantly reducing the environmental impact of our current industrial approach to animal husbandry. We can similarly engineer microbial products to [directly convert nitrogen](https://www.ginkgobioworks.com/offerings/agriculture/) from the air. This means all we need to do is introduce these microbes into the soil and we will be able to significantly reduce our dependence on artificial fertilizers.
...
Much of this data resides in the biological resources of [17 ‘mega-diverse’ countries](https://en.wikipedia.org/wiki/Megadiverse_countries), those with exceptional [biodiversity](../biodiversity): high levels of endemism and diversity of species and ecosystems, as well as significant ecological processes and functions.
...
##### On Biotech Innovation
- [164. The case for meat options that taste like the real thing](../164.-the-case-for-meat-options-that-taste-like-the-real-thing)
- [287. Problems and Solutions](../287.-problems-and-solutions)
- [075. Biology as Engineering](../075.-biology-as-engineering)
- [169. We must guard against the casual disregard of science](../169.-we-must-guard-against-the-casual-disregard-of-science)
##### On Healthcare Innovation
- [055. Path to Self-Improvement](../055.-path-to-self-improvement)
- [106. The lady with the lamp and data-driven medicine](../106.-the-lady-with-the-lamp-and-data-driven-medicine)
- [122. The downside of gene editing](../122.-the-downside-of-gene-editing)
- [123. Manufacturing drugs on demand](../123.-manufacturing-drugs-on-demand)
- [136. The Dilemma of Trying Out New Cures for Malaria](../136.-the-dilemma-of-trying-out-new-cures-for-malaria)
- [266. Phages and Precision Medicine](../266.-phages-and-precision-medicine)
##### On Investment in Science
- [272. Funding Science](../272.-funding-science)
- [246. Patient Capital](../246.-patient-capital)
##### On Open Access to Science
- [301. Open Access](../301.-open-access)

---
## 3. Endnotes
[^1]: https://www.bcg.com/publications/2022/synthetic-biology-is-about-to-disrupt-your-industry
[^2]: https://www.rebag.com/thevault/hermes-101-introducing-sylvania-mushroom-leather/
[^3]: https://www.furnituretoday.com/business-news/modern-meadow-biofabricates-leather-collagen-no-cows/