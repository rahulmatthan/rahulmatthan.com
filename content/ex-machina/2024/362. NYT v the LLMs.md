...
tags:
  - AI
  - IP
urlSecondary: https://www.livemint.com/opinion/online-views/the-nyt-s-copyright-lawsuit-against-openai-reveals-a-familiar-but-pointless-fear-11704205094732.html
urlCanonical: https://exmachina.in/03/01/2024/nyt-v.-the-llms/
Archive URL: https://archive.rahulmatthan.com/archive/1734089647.825562/www.livemint.com/opinion/online-views/the-nyt-s-copyright-lawsuit-against-openai-reveals-a-familiar-but-pointless-fear-11704205094732.html
category: article
...
_In the last week of 2023, the New York Times sued [openai_key.txt](../openai_key.txt) and Microsoft for copyright infringement. The allegations in the complaint go to the core of how generative AI works and could shape the manner in which AI works going forward._
...
One of the arguments in the New York Times’ complaint is that [openai_key.txt](../openai_key.txt)’s large language models (LLMs) demonstrate a kind of behaviour called “memorisation,” as a result of which, when supplied with a particular prompt, they repeat verbatim the material they were trained on. This, the complaint argues, allows [openai_key.txt](../openai_key.txt) users to bypass the New York Times firewall and access its copyright content without a subscription.
...
There have been suggestions that the complaint is just a negotiating tactic—that the New York Times has filed a complaint in order to pressure [openai_key.txt](../openai_key.txt) to agree to its licensing demands. After all, [openai_key.txt](../openai_key.txt) has agreed to [licensing deals](https://www.politico.eu/article/axel-springer-openai-launch-global-partnership/) with other media companies in the past, and it might just be a question of arriving at the right price with the New York-based newspaper.
