...
_To take full advantage of all that cutting-edge AI makes possible we will need access to frontier AI. Since these powerful models will likely only be made available to us through an API, this means that we will need to ensure access to these APIs in a way that_
