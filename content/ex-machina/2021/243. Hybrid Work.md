...
tags:
  - future_of_work
urlSecondary: https://www.livemint.com/opinion/columns/hybrid-work-is-the-future-but-we-re-not-quite-ready-yet-11622565306723.html
urlCanonical: https://exmachina.in/02/06/2021/hybrid-work/
category:
  - article
...
If hybrid work is ever going to become a reality, we will need to fundamentally rethink meetings. We need to redesign our [work spaces](../work-spaces) so that they function on the assumption that every meeting will comprise some people in the same physical space and others dialling in from a remote location.
...
When a good portion of our workforce plans to work from home, such measures create unnecessary friction. Nadella [suggests](https://www.linkedin.com/pulse/hybrid-work-paradox-satya-nadella) that, we need to adopt an [internet-first approach](../internet-first-approach):
