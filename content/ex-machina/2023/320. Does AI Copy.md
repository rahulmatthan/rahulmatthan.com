...
Last month, three of those artists filed a lawsuit against [openai_key.txt](../openai_key.txt), Stability AI and Midjourney, alleging violation of the three ‘Cs’ of copyright—consent, compensation and credit. They argued that not only had the image training data used by these AI engines been scraped off the internet with­out the con­sent of the orig­i­nal creators, none of these artists had either been offered any compensation or been given any credit for the final output. Getty Images initiated a different legal proceeding, claiming that these AI companies “chose to ignore viable licensing options and long‑standing legal protections in pursuit of their stand‑alone commercial interests”.
