...
tags:
  - data_protection
  - data_governance
created: 2025-12-10T20:22
externalUrl: https://www.livemint.com/opinion/online-views/india-privacy-law-outdated-ai-data-abundance-scarcity-artificial-intelligence-digital-personal-data-protection-11765199952737.html
urlCanonical: https://rahulmatthan.com/ex-machina/2025/456.-engineering-for-outcomes/
categories: "[[articles]]"
...
_Our data regulations still prescribe processes that must be followed to bring about the scarcity we have long believed will ensure data protection. Rather than prescribing processes, we should focus on engineering for the outcomes we want to achieve._
...
What we should have done instead is regulate outcomes. Rather than telling data fiduciaries how to process data, we should have told them that we will hold them [accountable](https://exmachina.in/29/06/2016/the-accountability-framework/) for the harms that result from the actions they perform. Rather than specifying the steps they need to take, we should have designed the law to assess, in real time, exactly what their algorithms do, so that when harm occurs, it can be detected early enough to be mitigated.
