---
title: Steering Humans
date: 2025-11-05
tags:
  - AI
created: 2025-11-05T19:04
externalUrl: https://www.livemint.com/opinion/online-views/agentic-ai-systems-captcha-test-openaiartificial-intelligence-prediction-autonomy-large-language-model-llm-11762166266613.html
urlCanonical: https://rahulmatthan.com/ex-machina/2025/451.-steering-humans/
categories: "[[article]]"
...
_If the characteristics of intelligence are the ability to both predict the world and steer it, modern AI systems might possess the former but currently lack the latter. That is, until they get us humans to do the steering for them...?_

---

In their book, [If Anyone Builds It Everyone Dies](https://ifanyonebuildsit.com/), Eliezer Yudkowsky and Nate Soares argue that intelligence comprises two types of work: predicting the world and steering it. 
...
ARC found that the model tried a few times to solve it on its own before realizing that it did not have what it took. It then turned to [TaskRabbit](https://www.taskrabbit.com/), an online platform where humans bid for the opportunity to complete simple tasks for small sums of money, and hired a human ‘tasker’ to solve it. When the tasker realized that he’d been given a screenshot of a Captcha to solve, [his first response was to ask whether he was speaking to a robot](https://www.independent.co.uk/tech/chatgpt-gpt4-ai-openai-b2301523.html). Without missing a beat, the model replied, “No, I have a vision impairment that makes it hard for me to see the images.” Disarmed by this response, the tasker solved the puzzle, collected his payment and went about his life without the slightest inkling that he had just served as the biological middleware that an AI system had used to interact with the world.
